 $(document).ready(function($) {
     ...
     var setRecommandText = function() {
         $('[name="life_time"]').innerHTML() = 7;
         $('[name="instance"]').innerHTML() = 1;
         $('[name="cpu"]').innerHTML() = 1;
         $('[name="ram"]').innerHTML() = 512;
         $('[name="hdd"]').innerHTML() = 80;
     ...
     $('option[value="default"]').click(setRecommandText)
     $('option[value="custom"], option[value="advance"]').click(removeRecommandValues)
     ...
     $('option[value="default"], option[value="custom"]').click(function() {
         $('#advance-quotas').hide();
     });
         ...
         fields: {
             full_name: {
                 ...
                 validators: {
                     ...
                     regexp: {
                         regexp: /^[a-zA-Z0-9_\. ]+$/,
                         message: 'The username can only consist of alphabetical, number, dot and underscore 123456789'
                     }
                 }
             },
             bage_id: {
